...
function merge(alphaFirst, alphaSecond) {
  ...
  for(let i = 0; i < catPixels.length; i++) {
    for (let j = 0; j < catPixels[i].length; j++) {
      pixels[i][j][0] = dogPixels[i][j][0] * alphaFirst + pixels[i][j][0] * alphaSecond;
      pixels[i][j][1] = dogPixels[i][j][1] * alphaFirst + pixels[i][j][1] * alphaSecond;
      pixels[i][j][2] = dogPixels[i][j][2] * alphaFirst + pixels[i][j][2] * alphaSecond;
    }
  }
