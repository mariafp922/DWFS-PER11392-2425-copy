...
function redConverter() {
  ...
  for (let i = 0; i <pixels.length ; i ++) {
    for (let j = 0; j <pixels[i].length ; j ++) {
      let r=pixels[i][j][0] //capturando el tono del canal R
      pixels[i][j]=[r,0,0]; //agregando el tono R y G, B en 0
...
function greenConverter() {
  ...
  for (let i = 0; i <pixels.length ; i ++) {
    for (let j = 0; j <pixels[i].length ; j ++) {
      let g=pixels[i][j][1] //capturando el tono del canal R
      pixels[i][j]=[0,g,0]; //agregando el tono R y G, B en 0
...
function merge(alphaFirst, alphaSecond) {
  ...
  for(let i = 0; i < catPixels.length; i++) {
    for (let j = 0; j < catPixels[i].length; j++) {
      ...
      pixels[i][j][1] = dogPixels[i][j][1] * alphaFirst + catPixels[i][j][1]  * alphaSecond;
      pixels[i][j][2] = dogPixels[i][j][2] * alphaFirst + catPixels[i][j][2]  * alphaSecond;
    }
  }
