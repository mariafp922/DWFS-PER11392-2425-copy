...
function merge(alphaFirst, alphaSecond) {
  ...
  for (let i = 0; i < catPixels.length; i++) {
    ...
    for (let j = 0; j < catPixels[i].length; j++) {
      let newPixel = [
        alphaSecond * catPixels[i][j][0] + alphaFirst * dogPixels[i][j][0],
        alphaSecond * catPixels[i][j][1] + alphaFirst * dogPixels[i][j][1],
        alphaSecond * catPixels[i][j][2] + alphaFirst * dogPixels[i][j][2],
      ];
